package com.exam.cripto.algorithm.rsa;

import static com.exam.cripto.algorithm.math.CMath.isCoprime;
import static com.exam.cripto.algorithm.math.CMath.modularMultiplicativeInverse;
import static com.exam.cripto.algorithm.math.CMath.modulo;
import static com.exam.cripto.algorithm.math.CMath.nextPrime;
import static com.exam.cripto.algorithm.math.CMath.randomPrime;
import static com.exam.cripto.algorithm.math.CMath.randomRange;
...
public class RSA {
    ...
    private Map<String, List<BigInteger>> generateKeys(Integer minValueForGeneration, Integer maxValueForGeneration) throws Exception {
        ...
        list.add(openExponent);
        list.add(n);
        list.add(BigInteger.valueOf(d));
        list.add(n);
